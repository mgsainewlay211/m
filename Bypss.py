...
CONFIG_FILE = "config_kuranomi.json"
...
loop_interval = 330  # 5.5 minute in seconds
...
def banner():
    ...
    print("\033[1;31m                 KURANOMI - WiFi Bypass Stable Edition\033[0m")
    print("\033[1;31m             Developer: @Kuranomi10\033[0m")
    print("\033[1;31m" + "="*56 + "\033[0m")
...
async def auto_loop_bypass(session_url, mac_address, voucher, gateway_ip):
    ...
    print(f"  ⏱️  Interval: {loop_interval} seconds (5.5 minute)")
    ...
    while auto_loop_running:
        ...
        if success:
            ...
            print("\n  ⚠️ Bypass failed, retrying in 5.5 minute...")
        
        # Wait for 330 seconds
        print(f"\n  ⏳ Waiting 330 seconds before next loop...")
