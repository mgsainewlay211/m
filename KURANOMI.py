...
def banner():
    ...
    print("\033[1;31m                 KURANOMI - WiFi Bypass Tool\033[0m")
...
def do_bypass(session_url, mac_address, voucher, gateway_ip):
    ...
    if not active_session_id:
        print(f"\033[1;31m[✗] Voucher code သက်တမ်းကုန်ဆုံးနေပါသည်\033[0m")
        return False
...
def start_bypass():
    ...
    if old_url:
        print(f"\033[1;34m[ သိမ်းဆည်းထား​သောURL ]: {old_url[:50]}...\033[0m")
